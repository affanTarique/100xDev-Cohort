...
function main(fileName) {
  // Ek main function banaya gaya hai jo fileName parameter lega.-----Jaise main("sample.txt") matlab ye function sample.txt file ke content read karega aur words count karega.
  fs.readFile(fileName, "utf-8", function (err, data) {
    //utf-8": iska matlab file ko text mode me padho (agar encoding na do to Buffer milega, jo human readable nahi hota).
